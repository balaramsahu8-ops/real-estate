...
new_df = pd.read_csv(ROOT_DIR / 'experiment' / 'data_viz1.csv')
with open(ROOT_DIR / 'models' / 'feature_text.pkl', 'rb') as file:
...
wordcloud_figure = plt.figure(figsize = (8, 8), facecolor = None)
